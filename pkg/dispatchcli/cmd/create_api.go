...
func NewCmdCreateAPI(out io.Writer, errOut io.Writer) *cobra.Command {
	...
	cmd.Flags().StringVarP(&auth, "auth", "", "public", "specify end-user authentication method, (e.g. public, basic, oauth2), default: public")
	return cmd
}
...
func createAPI(out, errOut io.Writer, cmd *cobra.Command, args []string) error {
	...
	if cmdFlagApplication != "" {
		api.Tags = append(api.Tags, &models.Tag{Key: "Application", Value: cmdFlagApplication})
	}
